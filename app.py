...
app.config['SQLALCHEMY_DATABASE_URI'] = app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://myuser:mypassword@npg_q9SDb6EgJdIXQep-quiet-lake-a9yvva3t-pooler.gwc.azure.neon.tech:5432/employee"
