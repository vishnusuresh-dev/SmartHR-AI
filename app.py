...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://neondb_owner:npg_q9SDb6EgJdIXQep-quiet-lake-a9yvva3t-pooler.gwc.azure.neon.tech/employee?sslmode=require&channel_binding=require"
